...
// O loader pode evoluir por correções de integridade, mas precisa continuar entregando
// explicitamente o submit REST canônico e a guarda semanal atual depois dele.
assert(loader.includes("const VERSION='10.10.58-intelsuite8'"),'Loader da suíte não foi cache-bustado para a revisão atual do transporte/integridade.');
