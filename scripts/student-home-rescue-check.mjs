...
assert(config.includes("version:'10.10.61-startup12'")&&config.includes("context:'role-aware-low-contention'"),'Loader não expõe a revisão de baixa contenção por contexto.');
