...
console.log('APROVADO — 10 ideias protegidas por arquitetura modular: radar, timeline, comparação, prioridades, próximas ações, metas, semáforo, resumo semanal, conquistas e modo revisão; leituras pesadas ficam sob demanda e não há polling/coleções paralelas.');
