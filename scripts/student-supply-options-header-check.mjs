...
assert(sharedQueue.indexOf(labelSrc)>=0&&sharedQueue.indexOf(labelSrc)<sharedQueue.indexOf('./modules/app-update-v10_10_9.js'),'Correção leve do título deve entrar no início da fila compartilhada.');
