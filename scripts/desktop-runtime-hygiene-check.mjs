...
expect(desktop.includes("version:'10.10.9-desktop1'"),'otimização desktop deve manter compatibilidade com o contrato de loader atual');
...
expect(globalPerf.includes("version:'10.10.9-perf2'"),'performance global deve manter compatibilidade com o contrato de loader atual');
