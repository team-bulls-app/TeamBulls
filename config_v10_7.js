...
(()=>{
  ...
  const trainerOnlyModules=new Set([
    ...
    MODULE_ROOT+'trainer-sent-reports-v10_10_33.js?v=10.10.33-sentreports1',
    MODULE_ROOT+'trainer-feedback-archive-v10_10_37.js?v=10.10.37-feedbackarchive1',
    MODULE_ROOT+'trainer-overdue-report-status-v10_10_33.js?v=10.10.33-overduestatus1',
